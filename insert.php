...
$sql="INSERT INTO lawyers (regno,name,gender,dob,doorno,street,locality,city,state,pincode,contact_no,email_id)
VALUES
(NULL,'$_POST[name]','$_POST[gender]','$_POST[dob]','$_POST[doorno]','$_POST[street]','$_POST[locality]','$_POST[city]','$_POST[state]','$_POST[pincode]','$_POST[contact_no]','$_POST[email_id]')";
