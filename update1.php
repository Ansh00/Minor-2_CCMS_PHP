...
$regno=$_SESSION['regno'];
   ...
   $query="select l.regno,l.name,l.gender,l.dob,l.doorno,l.street,l.locality,l.city,l.state,l.pincode,l.contact_no,l.email_id,q.llb,q.llm,q.mphil,q.phd,d.designation,d.court_abv,d.place_id
	...
	{
	$sql="INSERT INTO review (regno,name,gender,dob,doorno,street,locality,city,state,pincode,contact_no,email_id,llb,llm,mphil,phd,designation,court_abv,place_id)
    VALUES('$regno','$name','$gender','$dob','$doorno','$street','$locality','$city','$state','$pincode','$contact_no','$email_id','$llb','$llm','$mphil','$phd','$designation','$court_abv','$place_id')";
