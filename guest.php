...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <p><form method='POST' action='l.php'>By Reg no<br><input style='color:black;' type='text' size='6' name='regno' placeholder='regno'><input style='color:black;' type='submit' value='go'></form></p>
    <p><form method='POST' action='p.php'>By Place<br>
		<select name="placeid">
				...
				<input style='color:black;' type='submit' value='go'></form></p>
				
	<p><form method='POST' action='a.php'>By Age<br>above<input style='color:black;' type='text' size='2' name='age' placeholder='age'><input style='color:black;' type='submit' value='go'></form></p>

	<p><form method='POST' action='d.php'>By Designation<br>
    ...
    <a href="#cases" onclick="myAccFunc1()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn1">Cases <i class="fa fa-caret-down"></i></a>
    
    <div id="demoAcc1" class="w3-bar-block w3-hide w3-padding-large w3-medium">

    <p><form method='POST' action='c.php'>Handled by lawyer<br><input style='color:black;' type='text' size='6' name='regno' placeholder='regno'><input style='color:black;' type='submit' value='go'></form></p>
      <p><form method='POST' action='court.php'>by court<br><select name="court_abv">
      ...
      <a href="ongoing.php" class="w3-bar-item w3-button">ongoing cases</a>
        <p><form method='POST' action='date.php'>by date<br><input style='color:black;' type='date' name='date' placeholder='start date'><input style='color:black;' type='submit' value='go'></form></
    </div>
...
include('config.php');
	...
	$query="select l.regno,l.name,l.gender,l.city,l.contact_no,l.email_id,d.designation,c.court_name,p.place_name,r.rating
	...
	echo "<div>";
	echo"<table><tr><th>Reg no</th><th> Name</th><th>gender</th><th>city</th><th>contact no</th><th>email_id</th><th>designation</th><th>court name</th><th>place</th><th>rating</th><th>rate</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
...
?>
	...
	echo"<table><tr><th>Case_id</th><th>Case Title</th><th>case start date</th><th>case close date</th><th>case type</th><th>judgement</th><th>court</th><th>place</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
		$row=$result->fetch_array(MYSQLI_NUM);
