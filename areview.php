...
$query = "select regno,name,doorno,street,locality,city,state,pincode,contact_no,email_id,llb,llm,mphil,phd,designation,court_abv,place_id from review";
...
for ($j = 0 ;$j < $rows ; ++$j)
    ...
    for ($k = 0; $k <$m; ++$k)
		{	
			...
			$query="select l.regno,l.name,l.doorno,l.street,l.locality,l.city,l.state,l.pincode,l.contact_no,l.email_id,q.llb,q.llm,q.mphil,q.phd,d.designation,d.court_abv,d.place_id
