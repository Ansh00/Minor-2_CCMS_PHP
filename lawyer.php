...
echo "<div style='margin:10%;font-weight:40px;'>";
	...
	$query = "select l.regno,l.name,l.gender,l.dob,l.city,l.contact_no,l.email_id,p.place_name
	...
	echo"<table align='center' style='border:1px solid black;'><tr><th>Reg no</th><th> Name</th><th>gender</th><th>dob</th><th>Residence</th><th>contact no</th><th>email_id</th><th>view</th><th>Delete</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
