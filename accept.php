...
$regno=$_POST['accept'];
 ...
 $query = "select * from review
	...
	$sql="update lawyers
			set name='$name',gender='$gender',dob='$dob',doorno='$doorno',street='$street',locality='$locality',city='$city',state='$state',pincode='$pincode',contact_no='$contact_no',email_id='$email_id'
where regno='$regno'";
			$result = $db->query($sql);
